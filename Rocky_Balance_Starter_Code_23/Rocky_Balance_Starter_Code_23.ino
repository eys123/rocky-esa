...
void BalanceRocky()
{
  ...
  // float Ci = -6.768303157894737e+03;
  // float Ji = -4.637952000000000e+03;
  // float Jp = 1.895898452012384e+02;
  // float Ki = 2.206171932631579e+04;
  // float Kp = 4.434458567730802e+03;

  float Ci = -6.768303157894738e+03;
  float Ji = -4.915341473684211e+03;
  float Jp = 2.034593188854489e+02;
  float Ki = 2.322603208421053e+04;
  float Kp = 4.707601470232959e+03;
